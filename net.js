...
@compute @workgroup_size(2,16,4) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu30 = (((acc0-val63)*val64*alu28)+val66);
  data0[alu29] = (alu30*(1/(1.0f+exp2((alu30*-1.4426950408889634f)))));
  var alu32 = (((acc1-val67)*val68*alu25)+val70);
  data0[(alu29+43264)] = (alu32*(1/(1.0f+exp2((alu32*-1.4426950408889634f)))));
  var alu34 = (((acc2-val71)*val72*alu26)+val74);
  data0[(alu29+86528)] = (alu34*(1/(1.0f+exp2((alu34*-1.4426950408889634f)))));
  var alu36 = (((acc3-val75)*val76*alu27)+val78);
  data0[(alu29+129792)] = (alu36*(1/(1.0f+exp2((alu36*-1.4426950408889634f)))));
  var alu38 = (((acc4-val63)*val64*alu28)+val66);
  data0[(alu29+1)] = (alu38*(1/(1.0f+exp2((alu38*-1.4426950408889634f)))));
  var alu40 = (((acc5-val67)*val68*alu25)+val70);
  data0[(alu29+43265)] = (alu40*(1/(1.0f+exp2((alu40*-1.4426950408889634f)))));
  var alu42 = (((acc6-val71)*val72*alu26)+val74);
  data0[(alu29+86529)] = (alu42*(1/(1.0f+exp2((alu42*-1.4426950408889634f)))));
  var alu44 = (((acc7-val75)*val76*alu27)+val78);
  data0[(alu29+129793)] = (alu44*(1/(1.0f+exp2((alu44*-1.4426950408889634f)))));
  var alu46 = (((acc8-val63)*val64*alu28)+val66);
  data0[(alu29+2)] = (alu46*(1/(1.0f+exp2((alu46*-1.4426950408889634f)))));
  var alu48 = (((acc9-val67)*val68*alu25)+val70);
  data0[(alu29+43266)] = (alu48*(1/(1.0f+exp2((alu48*-1.4426950408889634f)))));
  var alu50 = (((acc10-val71)*val72*alu26)+val74);
  data0[(alu29+86530)] = (alu50*(1/(1.0f+exp2((alu50*-1.4426950408889634f)))));
  var alu52 = (((acc11-val75)*val76*alu27)+val78);
  data0[(alu29+129794)] = (alu52*(1/(1.0f+exp2((alu52*-1.4426950408889634f)))));
  var alu54 = (((acc12-val63)*val64*alu28)+val66);
  data0[(alu29+3)] = (alu54*(1/(1.0f+exp2((alu54*-1.4426950408889634f)))));
  var alu56 = (((acc13-val67)*val68*alu25)+val70);
  data0[(alu29+43267)] = (alu56*(1/(1.0f+exp2((alu56*-1.4426950408889634f)))));
  var alu58 = (((acc14-val71)*val72*alu26)+val74);
  data0[(alu29+86531)] = (alu58*(1/(1.0f+exp2((alu58*-1.4426950408889634f)))));
  var alu60 = (((acc15-val75)*val76*alu27)+val78);
  data0[(alu29+129795)] = (alu60*(1/(1.0f+exp2((alu60*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(8,8,2) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  data0[alu29] = (alu30*(1/(1.0f+exp2((alu30*-1.4426950408889634f)))));
  var alu32 = (((acc1-val67)*val68*alu25)+val70);
  data0[(alu29+10816)] = (alu32*(1/(1.0f+exp2((alu32*-1.4426950408889634f)))));
  var alu34 = (((acc2-val71)*val72*alu26)+val74);
  data0[(alu29+21632)] = (alu34*(1/(1.0f+exp2((alu34*-1.4426950408889634f)))));
  var alu36 = (((acc3-val75)*val76*alu27)+val78);
  data0[(alu29+32448)] = (alu36*(1/(1.0f+exp2((alu36*-1.4426950408889634f)))));
  var alu38 = (((acc4-val63)*val64*alu28)+val66);
  data0[(alu29+1)] = (alu38*(1/(1.0f+exp2((alu38*-1.4426950408889634f)))));
  var alu40 = (((acc5-val67)*val68*alu25)+val70);
  data0[(alu29+10817)] = (alu40*(1/(1.0f+exp2((alu40*-1.4426950408889634f)))));
  var alu42 = (((acc6-val71)*val72*alu26)+val74);
  data0[(alu29+21633)] = (alu42*(1/(1.0f+exp2((alu42*-1.4426950408889634f)))));
  var alu44 = (((acc7-val75)*val76*alu27)+val78);
  data0[(alu29+32449)] = (alu44*(1/(1.0f+exp2((alu44*-1.4426950408889634f)))));
  var alu46 = (((acc8-val63)*val64*alu28)+val66);
  data0[(alu29+2)] = (alu46*(1/(1.0f+exp2((alu46*-1.4426950408889634f)))));
  var alu48 = (((acc9-val67)*val68*alu25)+val70);
  data0[(alu29+10818)] = (alu48*(1/(1.0f+exp2((alu48*-1.4426950408889634f)))));
  var alu50 = (((acc10-val71)*val72*alu26)+val74);
  data0[(alu29+21634)] = (alu50*(1/(1.0f+exp2((alu50*-1.4426950408889634f)))));
  var alu52 = (((acc11-val75)*val76*alu27)+val78);
  data0[(alu29+32450)] = (alu52*(1/(1.0f+exp2((alu52*-1.4426950408889634f)))));
  var alu54 = (((acc12-val63)*val64*alu28)+val66);
  data0[(alu29+3)] = (alu54*(1/(1.0f+exp2((alu54*-1.4426950408889634f)))));
  var alu56 = (((acc13-val67)*val68*alu25)+val70);
  data0[(alu29+10819)] = (alu56*(1/(1.0f+exp2((alu56*-1.4426950408889634f)))));
  var alu58 = (((acc14-val71)*val72*alu26)+val74);
  data0[(alu29+21635)] = (alu58*(1/(1.0f+exp2((alu58*-1.4426950408889634f)))));
  var alu60 = (((acc15-val75)*val76*alu27)+val78);
  data0[(alu29+32451)] = (alu60*(1/(1.0f+exp2((alu60*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu13 = (((((val145*val48)+(val149*val49)+(val153*val50)+(val157*val51)+(val161*val52)+(val165*val53)+(val169*val54)+(val173*val55)+(val177*val56)+(val181*val57)+(val185*val58)+(val189*val59)+(val193*val60)+(val197*val61)+(val201*val62)+(val205*val63)+(val209*val64)+(val213*val65)+(val217*val66)+(val221*val67)+(val225*val68)+(val229*val69)+(val233*val70)+(val237*val71)+(val241*val72)+(val245*val73)+(val249*val74)+(val253*val75)+(val257*val76)+(val261*val77)+(val265*val78)+(val269*val79))-val4)*val5*alu8)+val7);
  data0[(alu12+10817)] = (alu13*(1/(1.0f+exp2((alu13*-1.4426950408889634f)))));
  var alu15 = (((((val145*val80)+(val149*val81)+(val153*val82)+(val157*val83)+(val161*val84)+(val165*val85)+(val169*val86)+(val173*val87)+(val177*val88)+(val181*val89)+(val185*val90)+(val189*val91)+(val193*val92)+(val197*val93)+(val201*val94)+(val205*val95)+(val209*val96)+(val213*val97)+(val217*val98)+(val221*val99)+(val225*val100)+(val229*val101)+(val233*val102)+(val237*val103)+(val241*val104)+(val245*val105)+(val249*val106)+(val253*val107)+(val257*val108)+(val261*val109)+(val265*val110)+(val269*val111))-val8)*val9*alu9)+val11);
  data0[(alu12+21633)] = (alu15*(1/(1.0f+exp2((alu15*-1.4426950408889634f)))));
  var alu17 = (((((val145*val112)+(val149*val113)+(val153*val114)+(val157*val115)+(val161*val116)+(val165*val117)+(val169*val118)+(val173*val119)+(val177*val120)+(val181*val121)+(val185*val122)+(val189*val123)+(val193*val124)+(val197*val125)+(val201*val126)+(val205*val127)+(val209*val128)+(val213*val129)+(val217*val130)+(val221*val131)+(val225*val132)+(val229*val133)+(val233*val134)+(val237*val135)+(val241*val136)+(val245*val137)+(val249*val138)+(val253*val139)+(val257*val140)+(val261*val141)+(val265*val142)+(val269*val143))-val12)*val13*alu10)+val15);
  data0[(alu12+32449)] = (alu17*(1/(1.0f+exp2((alu17*-1.4426950408889634f)))));
  var alu19 = (((((val145*val16)+(val149*val17)+(val153*val18)+(val157*val19)+(val161*val20)+(val165*val21)+(val169*val22)+(val173*val23)+(val177*val24)+(val181*val25)+(val185*val26)+(val189*val27)+(val193*val28)+(val197*val29)+(val201*val30)+(val205*val31)+(val209*val32)+(val213*val33)+(val217*val34)+(val221*val35)+(val225*val36)+(val229*val37)+(val233*val38)+(val237*val39)+(val241*val40)+(val245*val41)+(val249*val42)+(val253*val43)+(val257*val44)+(val261*val45)+(val265*val46)+(val269*val47))-val0)*val1*alu11)+val3);
  data0[(alu12+1)] = (alu19*(1/(1.0f+exp2((alu19*-1.4426950408889634f)))));
  var alu21 = (((((val146*val48)+(val150*val49)+(val154*val50)+(val158*val51)+(val162*val52)+(val166*val53)+(val170*val54)+(val174*val55)+(val178*val56)+(val182*val57)+(val186*val58)+(val190*val59)+(val194*val60)+(val198*val61)+(val202*val62)+(val206*val63)+(val210*val64)+(val214*val65)+(val218*val66)+(val222*val67)+(val226*val68)+(val230*val69)+(val234*val70)+(val238*val71)+(val242*val72)+(val246*val73)+(val250*val74)+(val254*val75)+(val258*val76)+(val262*val77)+(val266*val78)+(val270*val79))-val4)*val5*alu8)+val7);
  data0[(alu12+10818)] = (alu21*(1/(1.0f+exp2((alu21*-1.4426950408889634f)))));
  var alu23 = (((((val146*val80)+(val150*val81)+(val154*val82)+(val158*val83)+(val162*val84)+(val166*val85)+(val170*val86)+(val174*val87)+(val178*val88)+(val182*val89)+(val186*val90)+(val190*val91)+(val194*val92)+(val198*val93)+(val202*val94)+(val206*val95)+(val210*val96)+(val214*val97)+(val218*val98)+(val222*val99)+(val226*val100)+(val230*val101)+(val234*val102)+(val238*val103)+(val242*val104)+(val246*val105)+(val250*val106)+(val254*val107)+(val258*val108)+(val262*val109)+(val266*val110)+(val270*val111))-val8)*val9*alu9)+val11);
  data0[(alu12+21634)] = (alu23*(1/(1.0f+exp2((alu23*-1.4426950408889634f)))));
  var alu25 = (((((val146*val112)+(val150*val113)+(val154*val114)+(val158*val115)+(val162*val116)+(val166*val117)+(val170*val118)+(val174*val119)+(val178*val120)+(val182*val121)+(val186*val122)+(val190*val123)+(val194*val124)+(val198*val125)+(val202*val126)+(val206*val127)+(val210*val128)+(val214*val129)+(val218*val130)+(val222*val131)+(val226*val132)+(val230*val133)+(val234*val134)+(val238*val135)+(val242*val136)+(val246*val137)+(val250*val138)+(val254*val139)+(val258*val140)+(val262*val141)+(val266*val142)+(val270*val143))-val12)*val13*alu10)+val15);
  data0[(alu12+32450)] = (alu25*(1/(1.0f+exp2((alu25*-1.4426950408889634f)))));
  var alu27 = (((((val146*val16)+(val150*val17)+(val154*val18)+(val158*val19)+(val162*val20)+(val166*val21)+(val170*val22)+(val174*val23)+(val178*val24)+(val182*val25)+(val186*val26)+(val190*val27)+(val194*val28)+(val198*val29)+(val202*val30)+(val206*val31)+(val210*val32)+(val214*val33)+(val218*val34)+(val222*val35)+(val226*val36)+(val230*val37)+(val234*val38)+(val238*val39)+(val242*val40)+(val246*val41)+(val250*val42)+(val254*val43)+(val258*val44)+(val262*val45)+(val266*val46)+(val270*val47))-val0)*val1*alu11)+val3);
  data0[(alu12+2)] = (alu27*(1/(1.0f+exp2((alu27*-1.4426950408889634f)))));
  var alu29 = (((((val147*val48)+(val151*val49)+(val155*val50)+(val159*val51)+(val163*val52)+(val167*val53)+(val171*val54)+(val175*val55)+(val179*val56)+(val183*val57)+(val187*val58)+(val191*val59)+(val195*val60)+(val199*val61)+(val203*val62)+(val207*val63)+(val211*val64)+(val215*val65)+(val219*val66)+(val223*val67)+(val227*val68)+(val231*val69)+(val235*val70)+(val239*val71)+(val243*val72)+(val247*val73)+(val251*val74)+(val255*val75)+(val259*val76)+(val263*val77)+(val267*val78)+(val271*val79))-val4)*val5*alu8)+val7);
  data0[(alu12+10819)] = (alu29*(1/(1.0f+exp2((alu29*-1.4426950408889634f)))));
  var alu31 = (((((val147*val80)+(val151*val81)+(val155*val82)+(val159*val83)+(val163*val84)+(val167*val85)+(val171*val86)+(val175*val87)+(val179*val88)+(val183*val89)+(val187*val90)+(val191*val91)+(val195*val92)+(val199*val93)+(val203*val94)+(val207*val95)+(val211*val96)+(val215*val97)+(val219*val98)+(val223*val99)+(val227*val100)+(val231*val101)+(val235*val102)+(val239*val103)+(val243*val104)+(val247*val105)+(val251*val106)+(val255*val107)+(val259*val108)+(val263*val109)+(val267*val110)+(val271*val111))-val8)*val9*alu9)+val11);
  data0[(alu12+21635)] = (alu31*(1/(1.0f+exp2((alu31*-1.4426950408889634f)))));
  var alu33 = (((((val147*val112)+(val151*val113)+(val155*val114)+(val159*val115)+(val163*val116)+(val167*val117)+(val171*val118)+(val175*val119)+(val179*val120)+(val183*val121)+(val187*val122)+(val191*val123)+(val195*val124)+(val199*val125)+(val203*val126)+(val207*val127)+(val211*val128)+(val215*val129)+(val219*val130)+(val223*val131)+(val227*val132)+(val231*val133)+(val235*val134)+(val239*val135)+(val243*val136)+(val247*val137)+(val251*val138)+(val255*val139)+(val259*val140)+(val263*val141)+(val267*val142)+(val271*val143))-val12)*val13*alu10)+val15);
  data0[(alu12+32451)] = (alu33*(1/(1.0f+exp2((alu33*-1.4426950408889634f)))));
  var alu35 = (((((val147*val16)+(val151*val17)+(val155*val18)+(val159*val19)+(val163*val20)+(val167*val21)+(val171*val22)+(val175*val23)+(val179*val24)+(val183*val25)+(val187*val26)+(val191*val27)+(val195*val28)+(val199*val29)+(val203*val30)+(val207*val31)+(val211*val32)+(val215*val33)+(val219*val34)+(val223*val35)+(val227*val36)+(val231*val37)+(val235*val38)+(val239*val39)+(val243*val40)+(val247*val41)+(val251*val42)+(val255*val43)+(val259*val44)+(val263*val45)+(val267*val46)+(val271*val47))-val0)*val1*alu11)+val3);
  data0[(alu12+3)] = (alu35*(1/(1.0f+exp2((alu35*-1.4426950408889634f)))));
  var alu37 = (((((val144*val48)+(val148*val49)+(val152*val50)+(val156*val51)+(val160*val52)+(val164*val53)+(val168*val54)+(val172*val55)+(val176*val56)+(val180*val57)+(val184*val58)+(val188*val59)+(val192*val60)+(val196*val61)+(val200*val62)+(val204*val63)+(val208*val64)+(val212*val65)+(val216*val66)+(val220*val67)+(val224*val68)+(val228*val69)+(val232*val70)+(val236*val71)+(val240*val72)+(val244*val73)+(val248*val74)+(val252*val75)+(val256*val76)+(val260*val77)+(val264*val78)+(val268*val79))-val4)*val5*alu8)+val7);
  data0[(alu12+10816)] = (alu37*(1/(1.0f+exp2((alu37*-1.4426950408889634f)))));
  var alu39 = (((((val144*val80)+(val148*val81)+(val152*val82)+(val156*val83)+(val160*val84)+(val164*val85)+(val168*val86)+(val172*val87)+(val176*val88)+(val180*val89)+(val184*val90)+(val188*val91)+(val192*val92)+(val196*val93)+(val200*val94)+(val204*val95)+(val208*val96)+(val212*val97)+(val216*val98)+(val220*val99)+(val224*val100)+(val228*val101)+(val232*val102)+(val236*val103)+(val240*val104)+(val244*val105)+(val248*val106)+(val252*val107)+(val256*val108)+(val260*val109)+(val264*val110)+(val268*val111))-val8)*val9*alu9)+val11);
  data0[(alu12+21632)] = (alu39*(1/(1.0f+exp2((alu39*-1.4426950408889634f)))));
  var alu41 = (((((val144*val112)+(val148*val113)+(val152*val114)+(val156*val115)+(val160*val116)+(val164*val117)+(val168*val118)+(val172*val119)+(val176*val120)+(val180*val121)+(val184*val122)+(val188*val123)+(val192*val124)+(val196*val125)+(val200*val126)+(val204*val127)+(val208*val128)+(val212*val129)+(val216*val130)+(val220*val131)+(val224*val132)+(val228*val133)+(val232*val134)+(val236*val135)+(val240*val136)+(val244*val137)+(val248*val138)+(val252*val139)+(val256*val140)+(val260*val141)+(val264*val142)+(val268*val143))-val12)*val13*alu10)+val15);
  data0[(alu12+32448)] = (alu41*(1/(1.0f+exp2((alu41*-1.4426950408889634f)))));
  var alu43 = (((((val144*val16)+(val148*val17)+(val152*val18)+(val156*val19)+(val160*val20)+(val164*val21)+(val168*val22)+(val172*val23)+(val176*val24)+(val180*val25)+(val184*val26)+(val188*val27)+(val192*val28)+(val196*val29)+(val200*val30)+(val204*val31)+(val208*val32)+(val212*val33)+(val216*val34)+(val220*val35)+(val224*val36)+(val228*val37)+(val232*val38)+(val236*val39)+(val240*val40)+(val244*val41)+(val248*val42)+(val252*val43)+(val256*val44)+(val260*val45)+(val264*val46)+(val268*val47))-val0)*val1*alu11)+val3);
  data0[alu12] = (alu43*(1/(1.0f+exp2((alu43*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(4,8,2) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 16; ridx0++) {
    ...
    var val37 = select(0.0f, data1[(alu9+172952)], alu4);
    var val38 = select(0.0f, data1[(alu9+172953)], alu4);
    var val39 = select(0.0f, data1[(alu9+172954)], alu4);
    var val40 = select(0.0f, data1[(alu9+172955)], alu4);
    var val41 = select(0.0f, data1[(alu9+172956)], (alu4&alu7));
    var val42 = select(0.0f, data1[(alu9+173055)], alu5);
    ...
    var val48 = select(0.0f, data1[(alu9+173159)], (alu6&alu5));
  ...
  var alu36 = (((acc0-val54)*val55*alu34)+val57);
  data0[alu35] = (alu36*(1/(1.0f+exp2((alu36*-1.4426950408889634f)))));
  var alu38 = (((acc1-val58)*val59*alu31)+val61);
  data0[(alu35+10816)] = (alu38*(1/(1.0f+exp2((alu38*-1.4426950408889634f)))));
  var alu40 = (((acc2-val62)*val63*alu32)+val65);
  data0[(alu35+21632)] = (alu40*(1/(1.0f+exp2((alu40*-1.4426950408889634f)))));
  var alu42 = (((acc3-val66)*val67*alu33)+val69);
  data0[(alu35+32448)] = (alu42*(1/(1.0f+exp2((alu42*-1.4426950408889634f)))));
  var alu44 = (((acc4-val54)*val55*alu34)+val57);
  data0[(alu35+1)] = (alu44*(1/(1.0f+exp2((alu44*-1.4426950408889634f)))));
  var alu46 = (((acc5-val58)*val59*alu31)+val61);
  data0[(alu35+10817)] = (alu46*(1/(1.0f+exp2((alu46*-1.4426950408889634f)))));
  var alu48 = (((acc6-val62)*val63*alu32)+val65);
  data0[(alu35+21633)] = (alu48*(1/(1.0f+exp2((alu48*-1.4426950408889634f)))));
  var alu50 = (((acc7-val66)*val67*alu33)+val69);
  data0[(alu35+32449)] = (alu50*(1/(1.0f+exp2((alu50*-1.4426950408889634f)))));
  var alu52 = (((acc8-val54)*val55*alu34)+val57);
  data0[(alu35+2)] = (alu52*(1/(1.0f+exp2((alu52*-1.4426950408889634f)))));
  var alu54 = (((acc9-val58)*val59*alu31)+val61);
  data0[(alu35+10818)] = (alu54*(1/(1.0f+exp2((alu54*-1.4426950408889634f)))));
  var alu56 = (((acc10-val62)*val63*alu32)+val65);
  data0[(alu35+21634)] = (alu56*(1/(1.0f+exp2((alu56*-1.4426950408889634f)))));
  var alu58 = (((acc11-val66)*val67*alu33)+val69);
  data0[(alu35+32450)] = (alu58*(1/(1.0f+exp2((alu58*-1.4426950408889634f)))));
  var alu60 = (((acc12-val54)*val55*alu34)+val57);
  data0[(alu35+3)] = (alu60*(1/(1.0f+exp2((alu60*-1.4426950408889634f)))));
  var alu62 = (((acc13-val58)*val59*alu31)+val61);
  data0[(alu35+10819)] = (alu62*(1/(1.0f+exp2((alu62*-1.4426950408889634f)))));
  var alu64 = (((acc14-val62)*val63*alu32)+val65);
  data0[(alu35+21635)] = (alu64*(1/(1.0f+exp2((alu64*-1.4426950408889634f)))));
  var alu66 = (((acc15-val66)*val67*alu33)+val69);
  data0[(alu35+32451)] = (alu66*(1/(1.0f+exp2((alu66*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(4,8,2) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 16; ridx0++) {
    ...
    var val38 = select(0.0f, data2[(alu9+-104)], alu4);
    var val39 = select(0.0f, data2[(alu9+-103)], alu4);
    var val40 = select(0.0f, data2[(alu9+-102)], alu4);
    var val41 = select(0.0f, data2[(alu9+-101)], alu4);
    var val42 = select(0.0f, data2[(alu9+-100)], (alu4&alu7));
    var val43 = select(0.0f, data2[(alu9+-1)], alu5);
    var val44 = data2[(alu9+1)];
    var val45 = data2[(alu9+2)];
    var val46 = data2[(alu9+3)];
    var val47 = select(0.0f, data2[(alu9+4)], alu7);
    var val48 = select(0.0f, data2[(alu9+103)], (alu6&alu5));
  ...
  var alu36 = (((acc0-val70)*val71*alu35)+val73);
  data0[alu27] = (val54+(alu36*(1/(1.0f+exp2((alu36*-1.4426950408889634f))))));
  var alu38 = (((acc1-val74)*val75*alu32)+val77);
  data0[(alu27+10816)] = (val58+(alu38*(1/(1.0f+exp2((alu38*-1.4426950408889634f))))));
  var alu40 = (((acc2-val78)*val79*alu33)+val81);
  data0[(alu27+21632)] = (val62+(alu40*(1/(1.0f+exp2((alu40*-1.4426950408889634f))))));
  var alu42 = (((acc3-val82)*val83*alu34)+val85);
  data0[(alu27+32448)] = (val66+(alu42*(1/(1.0f+exp2((alu42*-1.4426950408889634f))))));
  var alu44 = (((acc4-val70)*val71*alu35)+val73);
  data0[(alu27+1)] = (val55+(alu44*(1/(1.0f+exp2((alu44*-1.4426950408889634f))))));
  var alu46 = (((acc5-val74)*val75*alu32)+val77);
  data0[(alu27+10817)] = (val59+(alu46*(1/(1.0f+exp2((alu46*-1.4426950408889634f))))));
  var alu48 = (((acc6-val78)*val79*alu33)+val81);
  data0[(alu27+21633)] = (val63+(alu48*(1/(1.0f+exp2((alu48*-1.4426950408889634f))))));
  var alu50 = (((acc7-val82)*val83*alu34)+val85);
  data0[(alu27+32449)] = (val67+(alu50*(1/(1.0f+exp2((alu50*-1.4426950408889634f))))));
  var alu52 = (((acc8-val70)*val71*alu35)+val73);
  data0[(alu27+2)] = (val56+(alu52*(1/(1.0f+exp2((alu52*-1.4426950408889634f))))));
  var alu54 = (((acc9-val74)*val75*alu32)+val77);
  data0[(alu27+10818)] = (val60+(alu54*(1/(1.0f+exp2((alu54*-1.4426950408889634f))))));
  var alu56 = (((acc10-val78)*val79*alu33)+val81);
  data0[(alu27+21634)] = (val64+(alu56*(1/(1.0f+exp2((alu56*-1.4426950408889634f))))));
  var alu58 = (((acc11-val82)*val83*alu34)+val85);
  data0[(alu27+32450)] = (val68+(alu58*(1/(1.0f+exp2((alu58*-1.4426950408889634f))))));
  var alu60 = (((acc12-val70)*val71*alu35)+val73);
  data0[(alu27+3)] = (val57+(alu60*(1/(1.0f+exp2((alu60*-1.4426950408889634f))))));
  var alu62 = (((acc13-val74)*val75*alu32)+val77);
  data0[(alu27+10819)] = (val61+(alu62*(1/(1.0f+exp2((alu62*-1.4426950408889634f))))));
  var alu64 = (((acc14-val78)*val79*alu33)+val81);
  data0[(alu27+21635)] = (val65+(alu64*(1/(1.0f+exp2((alu64*-1.4426950408889634f))))));
  var alu66 = (((acc15-val82)*val83*alu34)+val85);
  data0[(alu27+32451)] = (val69+(alu66*(1/(1.0f+exp2((alu66*-1.4426950408889634f))))));
}`;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  data0[alu4] = (val5+val8+val2);
  data0[alu5] = (val6+val9+val3);
  data0[alu6] = (val7+val10+val4);
  data0[alu3] = (val0+val11+val1);
}`;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu30 = (((acc0-val32)*val33*alu28)+val35);
  data0[alu29] = (alu30*(1/(1.0f+exp2((alu30*-1.4426950408889634f)))));
  var alu32 = (((acc1-val36)*val37*alu25)+val39);
  data0[(alu29+10816)] = (alu32*(1/(1.0f+exp2((alu32*-1.4426950408889634f)))));
  var alu34 = (((acc2-val40)*val41*alu26)+val43);
  data0[(alu29+21632)] = (alu34*(1/(1.0f+exp2((alu34*-1.4426950408889634f)))));
  var alu36 = (((acc3-val44)*val45*alu27)+val47);
  data0[(alu29+32448)] = (alu36*(1/(1.0f+exp2((alu36*-1.4426950408889634f)))));
  var alu38 = (((acc4-val32)*val33*alu28)+val35);
  data0[(alu29+1)] = (alu38*(1/(1.0f+exp2((alu38*-1.4426950408889634f)))));
  var alu40 = (((acc5-val36)*val37*alu25)+val39);
  data0[(alu29+10817)] = (alu40*(1/(1.0f+exp2((alu40*-1.4426950408889634f)))));
  var alu42 = (((acc6-val40)*val41*alu26)+val43);
  data0[(alu29+21633)] = (alu42*(1/(1.0f+exp2((alu42*-1.4426950408889634f)))));
  var alu44 = (((acc7-val44)*val45*alu27)+val47);
  data0[(alu29+32449)] = (alu44*(1/(1.0f+exp2((alu44*-1.4426950408889634f)))));
  var alu46 = (((acc8-val32)*val33*alu28)+val35);
  data0[(alu29+2)] = (alu46*(1/(1.0f+exp2((alu46*-1.4426950408889634f)))));
  var alu48 = (((acc9-val36)*val37*alu25)+val39);
  data0[(alu29+10818)] = (alu48*(1/(1.0f+exp2((alu48*-1.4426950408889634f)))));
  var alu50 = (((acc10-val40)*val41*alu26)+val43);
  data0[(alu29+21634)] = (alu50*(1/(1.0f+exp2((alu50*-1.4426950408889634f)))));
  var alu52 = (((acc11-val44)*val45*alu27)+val47);
  data0[(alu29+32450)] = (alu52*(1/(1.0f+exp2((alu52*-1.4426950408889634f)))));
  var alu54 = (((acc12-val32)*val33*alu28)+val35);
  data0[(alu29+3)] = (alu54*(1/(1.0f+exp2((alu54*-1.4426950408889634f)))));
  var alu56 = (((acc13-val36)*val37*alu25)+val39);
  data0[(alu29+10819)] = (alu56*(1/(1.0f+exp2((alu56*-1.4426950408889634f)))));
  var alu58 = (((acc14-val40)*val41*alu26)+val43);
  data0[(alu29+21635)] = (alu58*(1/(1.0f+exp2((alu58*-1.4426950408889634f)))));
  var alu60 = (((acc15-val44)*val45*alu27)+val47);
  data0[(alu29+32451)] = (alu60*(1/(1.0f+exp2((alu60*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(8,4) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 32; ridx0++) {
    ...
    var val37 = select(0.0f, data1[(alu8+86476)], alu3);
    var val38 = select(0.0f, data1[(alu8+86477)], alu3);
    var val39 = select(0.0f, data1[(alu8+86478)], alu3);
    var val40 = select(0.0f, data1[(alu8+86479)], alu3);
    var val41 = select(0.0f, data1[(alu8+86480)], (alu3&alu6));
    var val42 = select(0.0f, data1[(alu8+86527)], alu4);
    ...
    var val48 = select(0.0f, data1[(alu8+86579)], (alu5&alu4));
    ...
    var val53 = select(0.0f, data1[(alu8+86584)], (alu5&alu6));
    acc0 = (acc0+(val36*val0)+(val42*val3)+(val48*val6)+(val37*val1)+(val43*val4)+(val49*val7)+(val38*val2)+(val44*val5)+(val50*val8));
    acc1 = (acc1+(val36*val9)+(val42*val12)+(val48*val15)+(val37*val10)+(val43*val13)+(val49*val16)+(val38*val11)+(val44*val14)+(val50*val17));
    acc2 = (acc2+(val36*val18)+(val42*val21)+(val48*val24)+(val37*val19)+(val43*val22)+(val49*val25)+(val38*val20)+(val44*val23)+(val50*val26));
    acc3 = (acc3+(val36*val27)+(val42*val30)+(val48*val33)+(val37*val28)+(val43*val31)+(val49*val34)+(val38*val29)+(val44*val32)+(val50*val35));
  ...
  var alu35 = (((acc0-val54)*val55*alu33)+val57);
  data0[alu34] = (alu35*(1/(1.0f+exp2((alu35*-1.4426950408889634f)))));
  var alu37 = (((acc1-val58)*val59*alu30)+val61);
  data0[(alu34+2704)] = (alu37*(1/(1.0f+exp2((alu37*-1.4426950408889634f)))));
  var alu39 = (((acc2-val62)*val63*alu31)+val65);
  data0[(alu34+5408)] = (alu39*(1/(1.0f+exp2((alu39*-1.4426950408889634f)))));
  var alu41 = (((acc3-val66)*val67*alu32)+val69);
  data0[(alu34+8112)] = (alu41*(1/(1.0f+exp2((alu41*-1.4426950408889634f)))));
  var alu43 = (((acc4-val54)*val55*alu33)+val57);
  data0[(alu34+1)] = (alu43*(1/(1.0f+exp2((alu43*-1.4426950408889634f)))));
  var alu45 = (((acc5-val58)*val59*alu30)+val61);
  data0[(alu34+2705)] = (alu45*(1/(1.0f+exp2((alu45*-1.4426950408889634f)))));
  var alu47 = (((acc6-val62)*val63*alu31)+val65);
  data0[(alu34+5409)] = (alu47*(1/(1.0f+exp2((alu47*-1.4426950408889634f)))));
  var alu49 = (((acc7-val66)*val67*alu32)+val69);
  data0[(alu34+8113)] = (alu49*(1/(1.0f+exp2((alu49*-1.4426950408889634f)))));
  var alu51 = (((acc8-val54)*val55*alu33)+val57);
  data0[(alu34+2)] = (alu51*(1/(1.0f+exp2((alu51*-1.4426950408889634f)))));
  var alu53 = (((acc9-val58)*val59*alu30)+val61);
  data0[(alu34+2706)] = (alu53*(1/(1.0f+exp2((alu53*-1.4426950408889634f)))));
  var alu55 = (((acc10-val62)*val63*alu31)+val65);
  data0[(alu34+5410)] = (alu55*(1/(1.0f+exp2((alu55*-1.4426950408889634f)))));
  var alu57 = (((acc11-val66)*val67*alu32)+val69);
  data0[(alu34+8114)] = (alu57*(1/(1.0f+exp2((alu57*-1.4426950408889634f)))));
  var alu59 = (((acc12-val54)*val55*alu33)+val57);
  data0[(alu34+3)] = (alu59*(1/(1.0f+exp2((alu59*-1.4426950408889634f)))));
  var alu61 = (((acc13-val58)*val59*alu30)+val61);
  data0[(alu34+2707)] = (alu61*(1/(1.0f+exp2((alu61*-1.4426950408889634f)))));
  var alu63 = (((acc14-val62)*val63*alu31)+val65);
  data0[(alu34+5411)] = (alu63*(1/(1.0f+exp2((alu63*-1.4426950408889634f)))));
  var alu65 = (((acc15-val66)*val67*alu32)+val69);
  data0[(alu34+8115)] = (alu65*(1/(1.0f+exp2((alu65*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(8,4) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 32; ridx0++) {
    ...
    var val38 = select(0.0f, data2[(alu8+-52)], alu3);
    var val39 = select(0.0f, data2[(alu8+-51)], alu3);
    var val40 = select(0.0f, data2[(alu8+-50)], alu3);
    var val41 = select(0.0f, data2[(alu8+-49)], alu3);
    var val42 = select(0.0f, data2[(alu8+-48)], (alu3&alu6));
    var val43 = select(0.0f, data2[(alu8+-1)], alu4);
    var val44 = data2[(alu8+1)];
    var val45 = data2[(alu8+2)];
    var val46 = data2[(alu8+3)];
    var val47 = select(0.0f, data2[(alu8+4)], alu6);
    var val48 = select(0.0f, data2[(alu8+51)], (alu5&alu4));
    ...
    var val53 = select(0.0f, data2[(alu8+56)], (alu5&alu6));
    acc0 = (acc0+(val37*val0)+(val43*val3)+(val48*val6)+(val38*val1)+(val36*val4)+(val49*val7)+(val39*val2)+(val44*val5)+(val50*val8));
    acc1 = (acc1+(val37*val9)+(val43*val12)+(val48*val15)+(val38*val10)+(val36*val13)+(val49*val16)+(val39*val11)+(val44*val14)+(val50*val17));
    acc2 = (acc2+(val37*val18)+(val43*val21)+(val48*val24)+(val38*val19)+(val36*val22)+(val49*val25)+(val39*val20)+(val44*val23)+(val50*val26));
    acc3 = (acc3+(val37*val27)+(val43*val30)+(val48*val33)+(val38*val28)+(val36*val31)+(val49*val34)+(val39*val29)+(val44*val32)+(val50*val35));
  ...
  var alu35 = (((acc0-val70)*val71*alu34)+val73);
  data0[alu26] = (val54+(alu35*(1/(1.0f+exp2((alu35*-1.4426950408889634f))))));
  var alu37 = (((acc1-val74)*val75*alu31)+val77);
  data0[(alu26+2704)] = (val58+(alu37*(1/(1.0f+exp2((alu37*-1.4426950408889634f))))));
  var alu39 = (((acc2-val78)*val79*alu32)+val81);
  data0[(alu26+5408)] = (val62+(alu39*(1/(1.0f+exp2((alu39*-1.4426950408889634f))))));
  var alu41 = (((acc3-val82)*val83*alu33)+val85);
  data0[(alu26+8112)] = (val66+(alu41*(1/(1.0f+exp2((alu41*-1.4426950408889634f))))));
  var alu43 = (((acc4-val70)*val71*alu34)+val73);
  data0[(alu26+1)] = (val55+(alu43*(1/(1.0f+exp2((alu43*-1.4426950408889634f))))));
  var alu45 = (((acc5-val74)*val75*alu31)+val77);
  data0[(alu26+2705)] = (val59+(alu45*(1/(1.0f+exp2((alu45*-1.4426950408889634f))))));
  var alu47 = (((acc6-val78)*val79*alu32)+val81);
  data0[(alu26+5409)] = (val63+(alu47*(1/(1.0f+exp2((alu47*-1.4426950408889634f))))));
  var alu49 = (((acc7-val82)*val83*alu33)+val85);
  data0[(alu26+8113)] = (val67+(alu49*(1/(1.0f+exp2((alu49*-1.4426950408889634f))))));
  var alu51 = (((acc8-val70)*val71*alu34)+val73);
  data0[(alu26+2)] = (val56+(alu51*(1/(1.0f+exp2((alu51*-1.4426950408889634f))))));
  var alu53 = (((acc9-val74)*val75*alu31)+val77);
  data0[(alu26+2706)] = (val60+(alu53*(1/(1.0f+exp2((alu53*-1.4426950408889634f))))));
  var alu55 = (((acc10-val78)*val79*alu32)+val81);
  data0[(alu26+5410)] = (val64+(alu55*(1/(1.0f+exp2((alu55*-1.4426950408889634f))))));
  var alu57 = (((acc11-val82)*val83*alu33)+val85);
  data0[(alu26+8114)] = (val68+(alu57*(1/(1.0f+exp2((alu57*-1.4426950408889634f))))));
  var alu59 = (((acc12-val70)*val71*alu34)+val73);
  data0[(alu26+3)] = (val57+(alu59*(1/(1.0f+exp2((alu59*-1.4426950408889634f))))));
  var alu61 = (((acc13-val74)*val75*alu31)+val77);
  data0[(alu26+2707)] = (val61+(alu61*(1/(1.0f+exp2((alu61*-1.4426950408889634f))))));
  var alu63 = (((acc14-val78)*val79*alu32)+val81);
  data0[(alu26+5411)] = (val65+(alu63*(1/(1.0f+exp2((alu63*-1.4426950408889634f))))));
  var alu65 = (((acc15-val82)*val83*alu33)+val85);
  data0[(alu26+8115)] = (val69+(alu65*(1/(1.0f+exp2((alu65*-1.4426950408889634f))))));
}`;
...
@compute @workgroup_size(8,4) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 32; ridx0++) {
    ...
    var val38 = select(0.0f, data1[(alu8+-52)], alu3);
    var val39 = select(0.0f, data1[(alu8+-51)], alu3);
    var val40 = select(0.0f, data1[(alu8+-50)], alu3);
    var val41 = select(0.0f, data1[(alu8+-49)], alu3);
    var val42 = select(0.0f, data1[(alu8+-48)], (alu3&alu6));
    var val43 = select(0.0f, data1[(alu8+-1)], alu4);
    var val44 = data1[(alu8+1)];
    var val45 = data1[(alu8+2)];
    var val46 = data1[(alu8+3)];
    var val47 = select(0.0f, data1[(alu8+4)], alu6);
    var val48 = select(0.0f, data1[(alu8+51)], (alu5&alu4));
    ...
    var val53 = select(0.0f, data1[(alu8+56)], (alu5&alu6));
    acc0 = (acc0+(val37*val0)+(val43*val3)+(val48*val6)+(val38*val1)+(val36*val4)+(val49*val7)+(val39*val2)+(val44*val5)+(val50*val8));
    acc1 = (acc1+(val37*val9)+(val43*val12)+(val48*val15)+(val38*val10)+(val36*val13)+(val49*val16)+(val39*val11)+(val44*val14)+(val50*val17));
    acc2 = (acc2+(val37*val18)+(val43*val21)+(val48*val24)+(val38*val19)+(val36*val22)+(val49*val25)+(val39*val20)+(val44*val23)+(val50*val26));
    acc3 = (acc3+(val37*val27)+(val43*val30)+(val48*val33)+(val38*val28)+(val36*val31)+(val49*val34)+(val39*val29)+(val44*val32)+(val50*val35));
...
@compute @workgroup_size(8,4) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu50 = (((acc0-val70)*val71*alu49)+val73);
  data0[alu26] = (val54+(alu50*(1/(1.0f+exp2((alu50*-1.4426950408889634f))))));
  var alu52 = (((acc1-val74)*val75*alu46)+val77);
  data0[alu30] = (val58+(alu52*(1/(1.0f+exp2((alu52*-1.4426950408889634f))))));
  var alu54 = (((acc2-val78)*val79*alu47)+val81);
  data0[alu34] = (val62+(alu54*(1/(1.0f+exp2((alu54*-1.4426950408889634f))))));
  var alu56 = (((acc3-val82)*val83*alu48)+val85);
  data0[alu38] = (val66+(alu56*(1/(1.0f+exp2((alu56*-1.4426950408889634f))))));
  var alu58 = (((acc4-val70)*val71*alu49)+val73);
  data0[alu27] = (val55+(alu58*(1/(1.0f+exp2((alu58*-1.4426950408889634f))))));
  var alu60 = (((acc5-val74)*val75*alu46)+val77);
  data0[alu31] = (val59+(alu60*(1/(1.0f+exp2((alu60*-1.4426950408889634f))))));
  var alu62 = (((acc6-val78)*val79*alu47)+val81);
  data0[alu35] = (val63+(alu62*(1/(1.0f+exp2((alu62*-1.4426950408889634f))))));
  var alu64 = (((acc7-val82)*val83*alu48)+val85);
  data0[alu39] = (val67+(alu64*(1/(1.0f+exp2((alu64*-1.4426950408889634f))))));
  var alu66 = (((acc8-val70)*val71*alu49)+val73);
  data0[alu28] = (val56+(alu66*(1/(1.0f+exp2((alu66*-1.4426950408889634f))))));
  var alu68 = (((acc9-val74)*val75*alu46)+val77);
  data0[alu32] = (val60+(alu68*(1/(1.0f+exp2((alu68*-1.4426950408889634f))))));
  var alu70 = (((acc10-val78)*val79*alu47)+val81);
  data0[alu36] = (val64+(alu70*(1/(1.0f+exp2((alu70*-1.4426950408889634f))))));
  var alu72 = (((acc11-val82)*val83*alu48)+val85);
  data0[alu40] = (val68+(alu72*(1/(1.0f+exp2((alu72*-1.4426950408889634f))))));
  var alu74 = (((acc12-val70)*val71*alu49)+val73);
  data0[alu29] = (val57+(alu74*(1/(1.0f+exp2((alu74*-1.4426950408889634f))))));
  var alu76 = (((acc13-val74)*val75*alu46)+val77);
  data0[alu33] = (val61+(alu76*(1/(1.0f+exp2((alu76*-1.4426950408889634f))))));
  var alu78 = (((acc14-val78)*val79*alu47)+val81);
  data0[alu37] = (val65+(alu78*(1/(1.0f+exp2((alu78*-1.4426950408889634f))))));
  var alu80 = (((acc15-val82)*val83*alu48)+val85);
  data0[alu41] = (val69+(alu80*(1/(1.0f+exp2((alu80*-1.4426950408889634f))))));
}`;
...
@compute @workgroup_size(32,4) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu9 = (alu7+2);
  var val4 = select(0.0f, data3[alu9], alu4);
  var val5 = select(0.0f, data1[alu9], alu1);
  var alu10 = (alu7+3);
  var val6 = select(0.0f, data3[alu10], alu4);
  var val7 = select(0.0f, data1[alu10], alu1);
  var alu11 = ((alu1!=true)&alu2);
  ...
  data0[alu13] = (val0+val8+val15+val1);
  data0[(alu13+1)] = (val2+val9+val12+val3);
  data0[(alu13+2)] = (val5+val10+val13+val4);
  data0[(alu13+3)] = (val7+val11+val14+val6);
}`;
...
@compute @workgroup_size(32,2,2) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu14 = (((acc0-val45)*val46*sqrt((1/(val47+0.001f))))+val48);
  data0[alu13] = (alu14*(1/(1.0f+exp2((alu14*-1.4426950408889634f)))));
  var alu16 = (((acc1-val49)*val50*sqrt((1/(val51+0.001f))))+val52);
  data0[(alu13+676)] = (alu16*(1/(1.0f+exp2((alu16*-1.4426950408889634f)))));
  var alu18 = (((acc2-val53)*val54*sqrt((1/(val55+0.001f))))+val56);
  data0[(alu13+1352)] = (alu18*(1/(1.0f+exp2((alu18*-1.4426950408889634f)))));
  var alu20 = (((acc3-val57)*val58*sqrt((1/(val59+0.001f))))+val60);
  data0[(alu13+2028)] = (alu20*(1/(1.0f+exp2((alu20*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(32) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu29 = (((acc0-val32)*val33*alu27)+val35);
  data0[alu28] = (alu29*(1/(1.0f+exp2((alu29*-1.4426950408889634f)))));
  var alu31 = (((acc1-val36)*val37*alu24)+val39);
  data0[(alu28+676)] = (alu31*(1/(1.0f+exp2((alu31*-1.4426950408889634f)))));
  var alu33 = (((acc2-val40)*val41*alu25)+val43);
  data0[(alu28+1352)] = (alu33*(1/(1.0f+exp2((alu33*-1.4426950408889634f)))));
  var alu35 = (((acc3-val44)*val45*alu26)+val47);
  data0[(alu28+2028)] = (alu35*(1/(1.0f+exp2((alu35*-1.4426950408889634f)))));
  var alu37 = (((acc4-val32)*val33*alu27)+val35);
  data0[(alu28+1)] = (alu37*(1/(1.0f+exp2((alu37*-1.4426950408889634f)))));
  var alu39 = (((acc5-val36)*val37*alu24)+val39);
  data0[(alu28+677)] = (alu39*(1/(1.0f+exp2((alu39*-1.4426950408889634f)))));
  var alu41 = (((acc6-val40)*val41*alu25)+val43);
  data0[(alu28+1353)] = (alu41*(1/(1.0f+exp2((alu41*-1.4426950408889634f)))));
  var alu43 = (((acc7-val44)*val45*alu26)+val47);
  data0[(alu28+2029)] = (alu43*(1/(1.0f+exp2((alu43*-1.4426950408889634f)))));
  var alu45 = (((acc8-val32)*val33*alu27)+val35);
  data0[(alu28+2)] = (alu45*(1/(1.0f+exp2((alu45*-1.4426950408889634f)))));
  var alu47 = (((acc9-val36)*val37*alu24)+val39);
  data0[(alu28+678)] = (alu47*(1/(1.0f+exp2((alu47*-1.4426950408889634f)))));
  var alu49 = (((acc10-val40)*val41*alu25)+val43);
  data0[(alu28+1354)] = (alu49*(1/(1.0f+exp2((alu49*-1.4426950408889634f)))));
  var alu51 = (((acc11-val44)*val45*alu26)+val47);
  data0[(alu28+2030)] = (alu51*(1/(1.0f+exp2((alu51*-1.4426950408889634f)))));
  var alu53 = (((acc12-val32)*val33*alu27)+val35);
  data0[(alu28+3)] = (alu53*(1/(1.0f+exp2((alu53*-1.4426950408889634f)))));
  var alu55 = (((acc13-val36)*val37*alu24)+val39);
  data0[(alu28+679)] = (alu55*(1/(1.0f+exp2((alu55*-1.4426950408889634f)))));
  var alu57 = (((acc14-val40)*val41*alu25)+val43);
  data0[(alu28+1355)] = (alu57*(1/(1.0f+exp2((alu57*-1.4426950408889634f)))));
  var alu59 = (((acc15-val44)*val45*alu26)+val47);
  data0[(alu28+2031)] = (alu59*(1/(1.0f+exp2((alu59*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(16,2,2) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 64; ridx0++) {
    ...
    var val37 = select(0.0f, data1[(alu9+43238)], alu4);
    var val38 = select(0.0f, data1[(alu9+43239)], (alu4&alu7));
    var val39 = select(0.0f, data1[(alu9+43263)], alu5);
    var val40 = data1[(alu9+43264)];
    var val41 = select(0.0f, data1[(alu9+43265)], alu7);
    var val42 = select(0.0f, data1[(alu9+43289)], (alu6&alu5));
  ...
  var alu20 = (((acc0-val45)*val46*sqrt((1/(val47+0.001f))))+val48);
  data0[alu19] = (alu20*(1/(1.0f+exp2((alu20*-1.4426950408889634f)))));
  var alu22 = (((acc1-val49)*val50*sqrt((1/(val51+0.001f))))+val52);
  data0[(alu19+676)] = (alu22*(1/(1.0f+exp2((alu22*-1.4426950408889634f)))));
  var alu24 = (((acc2-val53)*val54*sqrt((1/(val55+0.001f))))+val56);
  data0[(alu19+1352)] = (alu24*(1/(1.0f+exp2((alu24*-1.4426950408889634f)))));
  var alu26 = (((acc3-val57)*val58*sqrt((1/(val59+0.001f))))+val60);
  data0[(alu19+2028)] = (alu26*(1/(1.0f+exp2((alu26*-1.4426950408889634f)))));
}`;
...
@compute @workgroup_size(16,2,2) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 64; ridx0++) {
    ...
    var val38 = select(0.0f, data2[(alu9+-26)], alu4);
    var val39 = select(0.0f, data2[(alu9+-25)], (alu4&alu7));
    var val40 = select(0.0f, data2[(alu9+-1)], alu5);
    var val41 = select(0.0f, data2[(alu9+1)], alu7);
    var val42 = select(0.0f, data2[(alu9+25)], (alu6&alu5));
  ...
  var alu20 = (((acc0-val49)*val50*sqrt((1/(val51+0.001f))))+val52);
  data0[alu15] = (val45+(alu20*(1/(1.0f+exp2((alu20*-1.4426950408889634f))))));
  var alu22 = (((acc1-val53)*val54*sqrt((1/(val55+0.001f))))+val56);
  data0[(alu15+676)] = (val46+(alu22*(1/(1.0f+exp2((alu22*-1.4426950408889634f))))));
  var alu24 = (((acc2-val57)*val58*sqrt((1/(val59+0.001f))))+val60);
  data0[(alu15+1352)] = (val47+(alu24*(1/(1.0f+exp2((alu24*-1.4426950408889634f))))));
  var alu26 = (((acc3-val61)*val62*sqrt((1/(val63+0.001f))))+val64);
  data0[(alu15+2028)] = (val48+(alu26*(1/(1.0f+exp2((alu26*-1.4426950408889634f))))));
}`;
...
@compute @workgroup_size(16,2,2) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 64; ridx0++) {
    ...
    var val38 = select(0.0f, data1[(alu9+-26)], alu4);
    var val39 = select(0.0f, data1[(alu9+-25)], (alu4&alu7));
    var val40 = select(0.0f, data1[(alu9+-1)], alu5);
    var val41 = select(0.0f, data1[(alu9+1)], alu7);
    var val42 = select(0.0f, data1[(alu9+25)], (alu6&alu5));
...
@compute @workgroup_size(16,2,2) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu23 = (((acc0-val49)*val50*sqrt((1/(val51+0.001f))))+val52);
  data0[alu15] = (val45+(alu23*(1/(1.0f+exp2((alu23*-1.4426950408889634f))))));
  var alu25 = (((acc1-val53)*val54*sqrt((1/(val55+0.001f))))+val56);
  data0[alu16] = (val46+(alu25*(1/(1.0f+exp2((alu25*-1.4426950408889634f))))));
  var alu27 = (((acc2-val57)*val58*sqrt((1/(val59+0.001f))))+val60);
  data0[alu17] = (val47+(alu27*(1/(1.0f+exp2((alu27*-1.4426950408889634f))))));
  var alu29 = (((acc3-val61)*val62*sqrt((1/(val63+0.001f))))+val64);
  data0[alu18] = (val48+(alu29*(1/(1.0f+exp2((alu29*-1.4426950408889634f))))));
}`;
...
@compute @workgroup_size(32) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  data0[alu5] = (val5+val8+val13+val2);
  data0[alu6] = (val6+val9+val14+val3);
  data0[alu7] = (val7+val10+val15+val4);
  data0[alu4] = (val0+val11+val12+val1);
}`;
...
@compute @workgroup_size(32) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu12 = (((acc0-val20)*val21*sqrt((1/(val22+0.001f))))+val23);
  data0[alu11] = (alu12*(1/(1.0f+exp2((alu12*-1.4426950408889634f)))));
  var alu14 = (((acc1-val24)*val25*sqrt((1/(val26+0.001f))))+val27);
  data0[(alu11+169)] = (alu14*(1/(1.0f+exp2((alu14*-1.4426950408889634f)))));
  var alu16 = (((acc2-val28)*val29*sqrt((1/(val30+0.001f))))+val31);
  data0[(alu11+338)] = (alu16*(1/(1.0f+exp2((alu16*-1.4426950408889634f)))));
  var alu18 = (((acc3-val32)*val33*sqrt((1/(val34+0.001f))))+val35);
...
@compute @workgroup_size(32) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu17 = (((acc0-val45)*val46*sqrt((1/(val47+0.001f))))+val48);
  data0[alu16] = (alu17*(1/(1.0f+exp2((alu17*-1.4426950408889634f)))));
  var alu19 = (((acc1-val49)*val50*sqrt((1/(val51+0.001f))))+val52);
  data0[(alu16+169)] = (alu19*(1/(1.0f+exp2((alu19*-1.4426950408889634f)))));
  var alu21 = (((acc2-val53)*val54*sqrt((1/(val55+0.001f))))+val56);
  data0[(alu16+338)] = (alu21*(1/(1.0f+exp2((alu21*-1.4426950408889634f)))));
  var alu23 = (((acc3-val57)*val58*sqrt((1/(val59+0.001f))))+val60);
...
@compute @workgroup_size(32) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu17 = (((acc0-val49)*val50*sqrt((1/(val51+0.001f))))+val52);
  data0[alu12] = (val45+(alu17*(1/(1.0f+exp2((alu17*-1.4426950408889634f))))));
  var alu19 = (((acc1-val53)*val54*sqrt((1/(val55+0.001f))))+val56);
  data0[(alu12+169)] = (val46+(alu19*(1/(1.0f+exp2((alu19*-1.4426950408889634f))))));
  var alu21 = (((acc2-val57)*val58*sqrt((1/(val59+0.001f))))+val60);
  data0[(alu12+338)] = (val47+(alu21*(1/(1.0f+exp2((alu21*-1.4426950408889634f))))));
  var alu23 = (((acc3-val61)*val62*sqrt((1/(val63+0.001f))))+val64);
  data0[(alu12+507)] = (val48+(alu23*(1/(1.0f+exp2((alu23*-1.4426950408889634f))))));
}`;
...
@compute @workgroup_size(32,4) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var val0 = select(0.0f, data2[alu6], alu3);
  var val1 = select(0.0f, data1[alu6], alu1);
  var alu7 = (alu6+1);
  var val2 = select(0.0f, data2[alu7], alu3);
  var val3 = select(0.0f, data1[alu7], alu1);
  var alu8 = (alu6+2);
  var val4 = select(0.0f, data2[alu8], alu3);
  var val5 = select(0.0f, data1[alu8], alu1);
  var alu9 = (alu6+3);
  var val6 = select(0.0f, data2[alu9], alu3);
  var val7 = select(0.0f, data1[alu9], alu1);
  var alu10 = ((alu1!=true)&alu2);
  ...
  data0[(alu11+1)] = (val3+val9+val2);
  data0[(alu11+2)] = (val5+val10+val4);
  data0[(alu11+3)] = (val7+val11+val6);
}`;
...
@compute @workgroup_size(16,4) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  data0[alu22] = (acc0+val32);
  data0[(alu22+1)] = (acc4+val32);
  data0[(alu22+2)] = (acc8+val32);
  data0[(alu22+3)] = (acc12+val32);
  data0[(alu22+2704)] = (acc1+val33);
  data0[(alu22+2705)] = (acc5+val33);
  data0[(alu22+2706)] = (acc9+val33);
  data0[(alu22+2707)] = (acc13+val33);
  data0[(alu22+5408)] = (acc2+val34);
  data0[(alu22+5409)] = (acc6+val34);
  data0[(alu22+5410)] = (acc10+val34);
  data0[(alu22+5411)] = (acc14+val34);
  data0[(alu22+8112)] = (acc3+val35);
  data0[(alu22+8113)] = (acc7+val35);
  data0[(alu22+8114)] = (acc11+val35);
  data0[(alu22+8115)] = (acc15+val35);
}`;
...
@compute @workgroup_size(16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  data0[alu21] = (acc0+val32);
  data0[(alu21+1)] = (acc4+val32);
  data0[(alu21+2)] = (acc8+val32);
  data0[(alu21+3)] = (acc12+val32);
  data0[(alu21+676)] = (acc1+val33);
  data0[(alu21+677)] = (acc5+val33);
  data0[(alu21+678)] = (acc9+val33);
  data0[(alu21+679)] = (acc13+val33);
  data0[(alu21+1352)] = (acc2+val34);
  data0[(alu21+1353)] = (acc6+val34);
  data0[(alu21+1354)] = (acc10+val34);
  data0[(alu21+1355)] = (acc14+val34);
  data0[(alu21+2028)] = (acc3+val35);
  data0[(alu21+2029)] = (acc7+val35);
  data0[(alu21+2030)] = (acc11+val35);
  data0[(alu21+2031)] = (acc15+val35);
}`;
...
@compute @workgroup_size(4,3) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var val6 = select(0.0f, data3[alu1], ((lidx0+(gidx1<<2))<1));
